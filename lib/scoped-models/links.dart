...
// fetch all the data of the degrees from the database
...
// fetch all the data of the facultues from the database
...
// convert faculties names to the relevat types
...
// fetch all data from importantLinks folder in the database 
